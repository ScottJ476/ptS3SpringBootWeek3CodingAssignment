...
//@Service  //The coding assignment says to add @Service, but in the videos he said the better
//option is to add @Component (he says it isn't really a service, repository, or controller).
@Component  
@Slf4j 
